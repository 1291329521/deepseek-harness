...
export const ChatNodeSeat = memo(function ChatNodeSeat({
  ...
  loadImage, renderMessageImages, fileMentions, annotations, useStore, actions, renderSlot, t,
}: ChatNodeSeatProps) {
  ...
  const owner = useMemo<ChatNodeOwnerProps | null>(() => node === undefined
    ...
    loadImage, renderMessageImages, fileMentions, annotations, turnProcess,
  ])
