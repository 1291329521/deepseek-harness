...
import terminologyRemote from '@deepseek-ai/dsh-client-ui-terminology/remote'
...
export type {} from '@deepseek-ai/dsh-client-ui-terminology/remote'
...
export type {} from '@deepseek-ai/dsh-client-ui-terminology/types'
...
export async function apply(ctx: Context): Promise<() => Promise<void>> {
  ...
  try {
    for (const contribution of [
      ...
      pluginInventoryRemote, messageFeedbackRemote, fileUploadsRemote, terminologyRemote, sessionReferencesRemote,
