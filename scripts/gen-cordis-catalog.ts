...
export const SERVICE_WALK_EXEMPTIONS: Record<string, string> = {
  ...
  chatAnnotations: 'client-side slot-contract accessor (ChatAnnotations) — packages/client/ui-chat/README.md owns the API',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  TerminologyStateRequest: 'plugin-local remote payload is owned by packages/client/ui-terminology/README.md',
  TerminologyStateResult: 'plugin-local remote payload is owned by packages/client/ui-terminology/README.md',
  TerminologyRememberRequest: 'plugin-local remote payload is owned by packages/client/ui-terminology/README.md',
  TerminologyRememberResult: 'plugin-local remote payload is owned by packages/client/ui-terminology/README.md',
  TerminologyExplainRequest: 'plugin-local remote payload is owned by packages/client/ui-terminology/README.md',
  TerminologyExplainResult: 'plugin-local remote payload is owned by packages/client/ui-terminology/README.md',
